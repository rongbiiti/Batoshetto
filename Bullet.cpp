...
void Bullet::DrawSHINOBIEXECUTION() {
	...
	if (waitingTimeAfterPlayerHit >= 210) {
		fontwidth = GetDrawFormatStringWidthToHandle(gameMain->fontData->f_FontData[1], "忍");
		DrawFormatStringToHandle(x - fontwidth / 2, 50,  0xdc143c, gameMain->fontData->f_FontData[2], "不");
		DrawFormatStringToHandle(x - fontwidth / 2, 200, 0xdc143c, gameMain->fontData->f_FontData[2], "死");
		DrawFormatStringToHandle(x - fontwidth / 2, 350, 0xdc143c, gameMain->fontData->f_FontData[2], "斬");
		DrawFormatStringToHandle(x - fontwidth / 2, 500, 0xdc143c, gameMain->fontData->f_FontData[2], "り");
