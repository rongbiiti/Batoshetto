...
void Bullet::DrawSHINOBIEXECUTION() {
	...
	if (waitingTimeAfterPlayerHit >= 210) {
		...
		DrawFormatStringToHandle(x - fontwidth / 2, 200, 0xFFFFFF, gameMain->fontData->f_FontData[2], "銃");
		DrawFormatStringToHandle(x - fontwidth / 2, 350, 0xFFFFFF, gameMain->fontData->f_FontData[2], "殺");
